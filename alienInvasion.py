    ...
    while Rerun:
        ...
        def iscollision(bx, by, ex, ey, i):
            ...
            if distance < 27:
                ...
                score += 1
                if score == 10:
                    print('Ek Enemy ship Badh Gaya hai')
                if score == 20:
                    print('Ek aur badh gay, bhai Sambhal Ke')
                if score == 30:
                    print('Bus Bhai aise hi mast Khel Raha hai')
                if score == 50:
                    print('Arre BC!!! Tu to half Century Bana Diya')
                if score == 70:
                    print('Bus Bhai! Aur Kitna Score Banayege')
                if score == 85:
                    print('Are Bus Kar! Game ka ab To Code Bhi khatam ho raha hai')
                if score == 100:
                    print('Zindagi bhar yahi khel...Game infinty loop kr diya Hu')
